...
if(!$sqf=simplexml_load_file(ROOT."in".DIRECTORY_SEPARATOR."ocean".DIRECTORY_SEPARATOR."ocean_files.xml")) die("oops");
if(!$sql=simplexml_load_file(ROOT."in".DIRECTORY_SEPARATOR."ocean".DIRECTORY_SEPARATOR."ocean_wares.xml")) die("oops");
