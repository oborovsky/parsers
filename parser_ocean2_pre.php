...
if(!$sqf=simplexml_load_file(ROOT."in".DIRECTORY_SEPARATOR."ocean".DIRECTORY_SEPARATOR."novelties_files.xml")) die("oops");
if(!$sql=simplexml_load_file(ROOT."in".DIRECTORY_SEPARATOR."ocean".DIRECTORY_SEPARATOR."novelties_wares.xml")) die("oops");
...
r("",$sql);
$d=count($out_array);
if($d) mysql_q("INSERT INTO `tmp_goods`(`mfg`,`art`,`cat`,`xml`) VALUES NEWONE".implode(",",$out_array));
echo "done:".$d;
?>